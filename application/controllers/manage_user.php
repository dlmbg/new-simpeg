	...
	*/
	...
	public function index()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			$d['tot'] = $offset;
			$tot_hal = $this->db->join('tbl_master_unit_kerja', 'tbl_master_unit_kerja.id_unit_kerja = tbl_user_login.id_unit_kerja', 'left')->get("tbl_user_login");
			...
			$d['status_pegawai'] = $this->db->join('tbl_master_unit_kerja', 'tbl_master_unit_kerja.id_unit_kerja = tbl_user_login.id_unit_kerja', 'left')->get("tbl_user_login",$limit,$offset);
